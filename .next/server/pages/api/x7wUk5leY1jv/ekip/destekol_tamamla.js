...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{
    if (req.method === "POST") {
        ...
        if (durum === "tamamla") {
            ...
            const result = await prisma.$queryRaw`UPDATE destekol set durum="tamamlandı",kapatan=${kapatan},kapandı=1,kapatmatarihi=${kapatmatarihi},kapatanaciklama=${kapatanaciklama} where id=${getir}`;
