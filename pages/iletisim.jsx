            ...
            <div class="container mx-auto">
              <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                  <div class="mb-12 mt-10 max-w-[570px] lg:mb-0">
                    ...
                    <p class="text-body-color mb-9 text-base leading-relaxed">
                      Bize ulaşmak için yan taraftaki formu doldurabilirsiniz. Diğer iletişim bilgilerimiz aşağıda yer almaktadır.
                    </p>
                    <div class="mb-8 flex w-full max-w-[370px]">
                      ...
                      <div class="w-full">
                        ...
                        <p class="text-body-color text-base">
                          Cumhuriyet Mah. Atatürk Bulvarı No:32/2 Çankırı 18100
                          Merkez
                        </p>
                      </div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                  <div class="relative rounded-lgp-8 sm:p-12">
                    <form>
                      <div class="mb-6">
                        <input
                          type="text"
                      ...
                      <div>
                        <button
                          type="submit"
                          class="bg-red-600 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                        >
                          Mesajı Gönder
                        </button>
                      </div>
